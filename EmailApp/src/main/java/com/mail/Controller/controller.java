...
public class controller {
	...
	public ResponseEntity<?> sendEmailWithFile(@RequestBody mailRequest request,@RequestParam MultipartFile file) {
	
		service.sendEmailWithFile(request.getTo(), request.getSubject(), request.getMessage(), file);
